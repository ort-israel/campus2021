...
function  theme_mop_general_get_main_scss_content($theme) {
    ...
    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/preset/Perception_variables.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/fordson_variables.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/preset/Perception.scss');

    // Page Layout
    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/pagelayout/layout1.scss');

    // Section Style
    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/sectionlayout/sectionstyle1.scss');

    if ($theme->settings->marketingstyle == 1) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/marketingstyle/marketingstyle1.scss');
    }
    if ($theme->settings->marketingstyle == 2) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/marketingstyle/marketingstyle2.scss');
    }
    if ($theme->settings->marketingstyle == 3) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/marketingstyle/marketingstyle3.scss');
    }
    if ($theme->settings->marketingstyle == 4) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/marketingstyle/marketingstyle4.scss');
    }

    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/mixins.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/course.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/modules.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/innerpages.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/header.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/footer.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/mop_general/scss/styles.scss');
