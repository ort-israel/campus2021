...
// Theme strings.
$string['choosereadme'] = 'Mop General provides a unique visual experience to the default Boost theme with customization features such as color choosers, improved navigation, and enhanced homepage experience.';
