...
$THEME->csstreepostprocessor = 'theme_mop_general_css_tree_post_processor';
$THEME->prescsscallback = 'theme_mop_general_get_pre_scss';
$THEME->extrascsscallback = 'theme_mop_general_get_extra_scss';
...
if (page_location6_incourse_themeconfig()) {
