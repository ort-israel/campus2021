...
/*  theme_campus_alternative BUILDING NOTES
 * =============================
...
if ($ADMIN->fulltree) {
    ...
    $settings = new theme_boost_admin_settingspage_tabs('themesettingcampus_alternative', get_string('configtitle', 'theme_campus_alternative'));
