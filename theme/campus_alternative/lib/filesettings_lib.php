...
function theme_campus_alternative_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    static $theme;
    if (empty($theme)) {
 ...
 * @return string
 */
function theme_campus_alternative_get_setting($setting, $format = false) {
    global $CFG;
