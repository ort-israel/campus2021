...
namespace theme_campus_alternative\output;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function full_header() {
        ...
        if (theme_campus_alternative_get_setting('jitsibuttontext') && $PAGE->pagelayout == 'course') {
...
' . $jitsibuttontext . ' </span></a>';
        ...
        return $this->render_from_template('theme_campus_alternative/header', $header);
    }
    ...
    public function headerimage() {
        ...
        if (theme_campus_alternative_get_setting('showcourseheaderimage') && $courseimage) {
        ...
        } else if (theme_campus_alternative_get_setting('showcourseheaderimage') && !$courseimage && isset($headerbg)) {
    ...
    */
    ...
    public function fordson_custom_menu() {
        ...
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            ...
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('mymodules', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismymodules', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemymodules', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('myunits', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismyunits', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemyunits', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('myclasses', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismyclasses', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemyclasses', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'training') {
                $branchtitle = get_string('mytraining', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismytraining', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemytraining', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'pd') {
                $branchtitle = get_string('myprofessionaldevelopment', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismyprofessionaldevelopment', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemyprofessionaldevelopment', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'cred') {
                $branchtitle = get_string('mycred', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismycred', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemycred', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'plan') {
                $branchtitle = get_string('myplans', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismyplans', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemyplans', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'comp') {
                $branchtitle = get_string('mycomp', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismycomp', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemycomp', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'program') {
                $branchtitle = get_string('myprograms', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismyprograms', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemyprograms', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'lecture') {
                $branchtitle = get_string('mylectures', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismylectures', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemylectures', 'theme_campus_alternative');
            } else if ($mycoursetitle == 'lesson') {
                $branchtitle = get_string('mylessons', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismylessons', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemylessons', 'theme_campus_alternative');
            } else {
                $branchtitle = get_string('mycourses', 'theme_campus_alternative');
                $thisbranchtitle = get_string('thismycourses', 'theme_campus_alternative');
                $homebranchtitle = get_string('homemycourses', 'theme_campus_alternative');
            }
            ...
            if ($courses = enrol_get_my_courses(NULL, 'fullname ASC')) {
                if (theme_campus_alternative_get_setting('frontpagemycoursessorting')) {
                    $courses = enrol_get_my_courses(null, 'sortorder ASC');
                    $nomycourses = '<div class="alert alert-info alert-block">' . get_string('nomycourses', 'theme_campus_alternative') . '</div>';
                    if ($courses) {
                ...
                $noenrolments = get_string('noenrolments', 'theme_campus_alternative');
    ...
    protected function render_courseactivities_menu(custom_menu $menu) {
        ...
        foreach ($menu->get_children() as $item) {
            $context = $item->export_for_template($this);
            $content .= $this->render_from_template('theme_campus_alternative/activitygroups', $context);
        }
        return $content;
    }
    ...
    public function courseactivities_menu() {
        ...
        if (isset($COURSE->id) && $COURSE->id > 1) {
            $branchtitle = get_string('courseactivities', 'theme_campus_alternative');
            $branchlabel = $branchtitle;
    ...
    public function social_icons() {
        ...
        return $this->render_from_template('theme_campus_alternative/socialicons', $socialcontext);
    }
    ...
    public function customlogin() {
        ...
        return $this->render_from_template('theme_campus_alternative/customlogin', $customlogin_context);
    }
    ...
    public function teacherdash() {
        ...
        if (isloggedin() && isset($COURSE->id) && $COURSE->id > 1) {
            ...
            if (has_capability('moodle/course:viewhiddenactivities', $context)) {
                $togglebutton = get_string('coursemanagementbutton', 'theme_campus_alternative');
            } else {
                $togglebuttonstudent = get_string('studentdashbutton', 'theme_campus_alternative');
            }
        }
        $course = $this->page->course;
        $context = context_course::instance($course->id);
        ...
        $userlinks = get_string('userlinks', 'theme_campus_alternative');
        $userlinksdesc = get_string('userlinks_desc', 'theme_campus_alternative');
        $qbank = get_string('qbank', 'theme_campus_alternative');
        $qbankdesc = get_string('qbank_desc', 'theme_campus_alternative');
        $badges = get_string('badges', 'theme_campus_alternative');
        $badgesdesc = get_string('badges_desc', 'theme_campus_alternative');
        $coursemanage = get_string('coursemanage', 'theme_campus_alternative');
        $coursemanagedesc = get_string('coursemanage_desc', 'theme_campus_alternative');
        ...
        $progress = $this->render_from_template('theme_campus_alternative/progress-bar', $progresschartcontext);

        $gradeslinkstudent = new moodle_url('/grade/report/user/index.php', array(
            'id' => $PAGE->course->id
        ));
        $hascourseinfogroup = array(
            'title' => get_string('courseinfo', 'theme_campus_alternative'),
            'icon' => 'map'
        );
        ...
        $hascoursestaff = array(
            'title' => get_string('coursestaff', 'theme_campus_alternative'),
            'icon' => 'users'
        );
        ...
        $activitylinkstitle = get_string('activitylinkstitle', 'theme_campus_alternative');
        $activitylinkstitle_desc = get_string('activitylinkstitle_desc', 'theme_campus_alternative');
        $mygradestext = get_string('mygradestext', 'theme_campus_alternative');
        ...
        return $this->render_from_template('theme_campus_alternative/teacherdash', $dashlinks);
    }
    ...
    public function footer_details_title() {
        return get_string('contactandsupporttitle', 'theme_campus_alternative');
    }
    ...
    public function show_student_navbarcolor() {
        global $PAGE;
        $theme = theme_config::load('campus_alternative');
        $context = $this->page->context;
