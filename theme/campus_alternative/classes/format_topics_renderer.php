...
class theme_campus_format_topics_renderer extends format_topics_renderer {
    ...
    */ 
    protected function section_activity_summary($section, $course, $mods) {
        ...
        // $title = get_section_name($course, $section);
        $linktitle = get_string('viewsectionmodules',  'theme_campus_alternative');
        ...
        $output .= html_writer::tag('span', get_string('section_mods',  'theme_campus_alternative') , array(
