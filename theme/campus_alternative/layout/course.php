...
$PAGE->requires->js('/theme/campus_alternative/javascript/scrolltotop.js');
$PAGE->requires->js('/theme/campus_alternative/javascript/scrollspy.js');
$PAGE->requires->js('/theme/campus_alternative/javascript/blockslider.js');
...
$PAGE->requires->css('/theme/campus_alternative/style/select2.min.css');
$PAGE->requires->js('/theme/campus_alternative/javascript/select2.min.js', true); // Lea 2019/10 - without the "true", an error is thrown in console: "Error: Mismatched anonymous define() module"
$PAGE->requires->js('/theme/campus_alternative/javascript/applyselect2.js?ver=' . filemtime($CFG->dirroot . '/theme/campus_alternative/javascript/applyselect2.js'));

/* Lea 2020/11 - Add JS that injects classes into Category page elements */
$PAGE->requires->js('/theme/campus_alternative/javascript/categoryclasses.js');

$PAGE->requires->js('/theme/campus_alternative/javascript/courseblock.js');

$PAGE->requires->js('/theme/campus_alternative/javascript/toggleabout.js');

$nav = $PAGE->flatnav;
$templatecontext['flatnavigation'] = $nav;
$templatecontext['firstcollectionlabel'] = $nav->get_collectionlabel();
echo $OUTPUT->render_from_template( 'theme_campus_alternative/columns2', $templatecontext);