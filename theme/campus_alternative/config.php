...
$THEME->scss = function($theme) {
    return theme_campus_alternative_get_main_scss_content($theme);
};
...
$THEME->csstreepostprocessor = 'theme_campus_alternative_css_tree_post_processor';
$THEME->prescsscallback = 'theme_campus_alternative_get_pre_scss';
$THEME->extrascsscallback = 'theme_campus_alternative_get_extra_scss';
$THEME->rendererfactory = 'theme_overridden_renderer_factory';

// Toggle display of blocks
if (isset($THEME->settings->blockdisplay) && $THEME->settings->blockdisplay == 1) {
    $THEME->addblockposition = BLOCK_ADDBLOCK_POSITION_DEFAULT;
}
if (page_location3_incourse_themeconfig()) {
