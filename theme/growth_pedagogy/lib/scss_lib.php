...
function  theme_growth_pedagogy_get_main_scss_content($theme) {
    ...
    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/preset/Perception_variables.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/fordson_variables.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/preset/Perception.scss');

    // Page Layout
    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/pagelayout/layout1.scss');

    // Section Style
    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/sectionlayout/sectionstyle1.scss');

    if ($theme->settings->marketingstyle == 1) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/marketingstyle/marketingstyle1.scss');
    }
    if ($theme->settings->marketingstyle == 2) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/marketingstyle/marketingstyle2.scss');
    }
    if ($theme->settings->marketingstyle == 3) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/marketingstyle/marketingstyle3.scss');
    }
    if ($theme->settings->marketingstyle == 4) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/marketingstyle/marketingstyle4.scss');
    }

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/mixins.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/featuredcourses.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/categorylist.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/statistics.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/course.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/modules.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/innerpages.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/header.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/footer.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/growth_pedagogy/scss/styles.scss');
