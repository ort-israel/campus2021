...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function full_header() {
        ...
        return $this->render_from_template('theme_growth_pedagogy/header', $header);
    }
    ...
    public function growth_pedagogy_custom_menu() {
        ...
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            ...
            $branchtitle = get_string('mycourses', 'theme_growth_pedagogy');
            $thisbranchtitle = get_string('thismycourses', 'theme_growth_pedagogy');
            $homebranchtitle = get_string('homemycourses', 'theme_growth_pedagogy');
            ...
            if ($courses = enrol_get_my_courses(NULL, 'fullname ASC')) {
                ...
                $nomycourses = '<div class="alert alert-info alert-block">' . get_string('nomycourses', 'theme_growth_pedagogy') . '</div>';
                if ($courses) {
                ...
                $noenrolments = get_string('noenrolments', 'theme_growth_pedagogy');
    ...
    protected function render_courseactivities_menu(custom_menu $menu) {
        ...
        foreach ($menu->get_children() as $item) {
            $context = $item->export_for_template($this);
            $content .= $this->render_from_template(' theme_growth_pedagogy/activitygroups', $context);
        }
        return $content;
    }
    ...
    public function courseactivities_menu() {
        ...
        $context = $this->page->context;
        if (isset($COURSE->id) && $COURSE->id > 1) {
            $branchtitle = get_string('courseactivities', 'theme_growth_pedagogy');
            $branchlabel = $branchtitle;
            $branchurl = new moodle_url('#');
            $branch = $menu->add($branchlabel, $branchurl, $branchtitle, 10002);
            $data = theme_growth_pedagogy_get_course_activities();
    ...
    public function social_icons() {
        ...
        return $this->render_from_template(' theme_growth_pedagogy/socialicons', $socialcontext);
    }
    ...
    public function customlogin() {
        ...
        return $this->render_from_template(' theme_growth_pedagogy/customlogin', $customlogin_context);
    }
    ...
    public function teacherdash() {
        ...
        if (isloggedin() && isset($COURSE->id) && $COURSE->id > 1) {
            ...
            if (has_capability('moodle/course:viewhiddenactivities', $context)) {
                $togglebutton = get_string('coursemanagementbutton', 'theme_growth_pedagogy');
            } else {
                $togglebuttonstudent = get_string('studentdashbutton', 'theme_growth_pedagogy');
            }
        }
        $course = $this->page->course;
        $context = context_course::instance($course->id);
        ...
        $userlinks = get_string('userlinks', 'theme_growth_pedagogy');
        $userlinksdesc = get_string('userlinks_desc', 'theme_growth_pedagogy');
        $qbank = get_string('qbank', 'theme_growth_pedagogy');
        $qbankdesc = get_string('qbank_desc', 'theme_growth_pedagogy');
        $badges = get_string('badges', 'theme_growth_pedagogy');
        $badgesdesc = get_string('badges_desc', 'theme_growth_pedagogy');
        $coursemanage = get_string('coursemanage', 'theme_growth_pedagogy');
        $coursemanagedesc = get_string('coursemanage_desc', 'theme_growth_pedagogy');
        ...
        $progress = $this->render_from_template(' theme_growth_pedagogy/progress-bar', $progresschartcontext);

        $gradeslinkstudent = new moodle_url('/grade/report/user/index.php', array(
            'id' => $PAGE->course->id
        ));
        $hascourseinfogroup = array(
            'title' => get_string('courseinfo', 'theme_growth_pedagogy'),
            'icon' => 'map'
        );
        ...
        $hascoursestaff = array(
            'title' => get_string('coursestaff', 'theme_growth_pedagogy'),
            'icon' => 'users'
        );
        ...
        $activitylinkstitle = get_string('activitylinkstitle', 'theme_growth_pedagogy');
        $activitylinkstitle_desc = get_string('activitylinkstitle_desc', 'theme_growth_pedagogy');
        $mygradestext = get_string('mygradestext', 'theme_growth_pedagogy');
