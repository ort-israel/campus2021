 ...
 */
function theme_bediukcity_css_tree_post_processor($tree, $theme) {
 ...
 * @return string
 */
function theme_bediukcity_get_main_scss_content($theme) {
    global $CFG;

    $scss = '';

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/preset/Perception_variables.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/fordson_variables.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/preset/Perception.scss');

    // Page Layout
    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/pagelayout/layout1.scss');

    // Section Style
    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/sectionlayout/sectionstyle1.scss');

    if ($theme->settings->marketingstyle == 1) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/marketingstyle/marketingstyle1.scss');
    }
    if ($theme->settings->marketingstyle == 2) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/marketingstyle/marketingstyle2.scss');
    }
    if ($theme->settings->marketingstyle == 3) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/marketingstyle/marketingstyle3.scss');
    }
    if ($theme->settings->marketingstyle == 4) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/marketingstyle/marketingstyle4.scss');
    }

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/mixins.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/statistics.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/course.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/modules.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/innerpages.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/header.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/footer.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediukcity/scss/styles.scss');
 ...
 * @return array
 */
function theme_bediukcity_get_pre_scss($theme) {
    global $CFG, $PAGE;
