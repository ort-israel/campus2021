...
$string['choosereadme'] = 'Theme Bediuk City is a child theme of Boost based on Fordson. It is customized to ORT ISrael needs.';
...
// Bediuk Citysettings
$string['generalsettings'] = 'הגדרות כלליות לתבנית';
$string['maincolor'] = 'צבע ראשי';
$string['maincolor_desc'] = 'צבע ראשי לתבנית';
