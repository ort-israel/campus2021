...
// Theme strings.
$string['choosereadme'] = 'Bediuk City provides a unique visual experience to the default Boost theme with customization features such as color choosers, improved navigation, and enhanced homepage experience.';
$string['configtitle'] = 'BediukCity';
$string['pluginname'] = 'BediukCity';
...
$string['maincolor_desc'] = 'Main color for the theme';
