...
$PAGE->requires->js('/theme/bediukcity/javascript/scrolltotop.js');
$PAGE->requires->js('/theme/bediukcity/javascript/scrollspy.js');
$PAGE->requires->js('/theme/bediukcity/javascript/blockslider.js');
...
$PAGE->requires->css('/theme/bediukcity/style/select2.min.css');
$PAGE->requires->js('/theme/bediukcity/javascript/select2.min.js', true); // Lea 2019/10 - without the "true", an error is thrown in console: "Error: Mismatched anonymous define() module"
$PAGE->requires->js('/theme/bediukcity/javascript/applyselect2.js?ver=' . filemtime($CFG->dirroot . '/theme/bediukcity/javascript/applyselect2.js'));

/* Lea 2020/11 - Add JS that injects classes into Category page elements */
$PAGE->requires->js('/theme/bediukcity/javascript/categoryclasses.js');

$PAGE->requires->js('/theme/bediukcity/javascript/courseblock.js');

$nav = $PAGE->flatnav;
$templatecontext['flatnavigation'] = $nav;
$templatecontext['firstcollectionlabel'] = $nav->get_collectionlabel();
echo $OUTPUT->render_from_template( 'theme_bediukcity/columns2', $templatecontext);