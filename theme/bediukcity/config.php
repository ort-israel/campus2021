...
$THEME->scss = function($theme) {
    return theme_bediukcity_get_main_scss_content($theme);
};
...
$THEME->csstreepostprocessor = 'theme_bediukcity_css_tree_post_processor';
$THEME->prescsscallback = 'theme_bediukcity_get_pre_scss';
$THEME->extrascsscallback = 'theme_bediukcity_get_extra_scss';
...
if (page_location7_incourse_themeconfig()) {
