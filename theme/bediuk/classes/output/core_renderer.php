...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function full_header() {
        ...
        return $this->render_from_template('theme_bediuk/header', $header);
    }
    ...
    public function context_header($headerinfo = null, $headinglevel = 1) {
        ...
        if (empty($logo)) {
            $logo = new moodle_url($CFG->wwwroot . '/theme/bediuk/pix/logo.png');
        }
    ...
    public function fordson_custom_menu() {
        ...
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            ...
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('mymodules', 'theme_bediuk');
                $thisbranchtitle = get_string('thismymodules', 'theme_bediuk');
                $homebranchtitle = get_string('homemymodules', 'theme_bediuk');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('myunits', 'theme_bediuk');
                $thisbranchtitle = get_string('thismyunits', 'theme_bediuk');
                $homebranchtitle = get_string('homemyunits', 'theme_bediuk');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('myclasses', 'theme_bediuk');
                $thisbranchtitle = get_string('thismyclasses', 'theme_bediuk');
                $homebranchtitle = get_string('homemyclasses', 'theme_bediuk');
            } else if ($mycoursetitle == 'training') {
                $branchtitle = get_string('mytraining', 'theme_bediuk');
                $thisbranchtitle = get_string('thismytraining', 'theme_bediuk');
                $homebranchtitle = get_string('homemytraining', 'theme_bediuk');
            } else if ($mycoursetitle == 'pd') {
                $branchtitle = get_string('myprofessionaldevelopment', 'theme_bediuk');
                $thisbranchtitle = get_string('thismyprofessionaldevelopment', 'theme_bediuk');
                $homebranchtitle = get_string('homemyprofessionaldevelopment', 'theme_bediuk');
            } else if ($mycoursetitle == 'cred') {
                $branchtitle = get_string('mycred', 'theme_bediuk');
                $thisbranchtitle = get_string('thismycred', 'theme_bediuk');
                $homebranchtitle = get_string('homemycred', 'theme_bediuk');
            } else if ($mycoursetitle == 'plan') {
                $branchtitle = get_string('myplans', 'theme_bediuk');
                $thisbranchtitle = get_string('thismyplans', 'theme_bediuk');
                $homebranchtitle = get_string('homemyplans', 'theme_bediuk');
            } else if ($mycoursetitle == 'comp') {
                $branchtitle = get_string('mycomp', 'theme_bediuk');
                $thisbranchtitle = get_string('thismycomp', 'theme_bediuk');
                $homebranchtitle = get_string('homemycomp', 'theme_bediuk');
            } else if ($mycoursetitle == 'program') {
                $branchtitle = get_string('myprograms', 'theme_bediuk');
                $thisbranchtitle = get_string('thismyprograms', 'theme_bediuk');
                $homebranchtitle = get_string('homemyprograms', 'theme_bediuk');
            } else if ($mycoursetitle == 'lecture') {
                $branchtitle = get_string('mylectures', 'theme_bediuk');
                $thisbranchtitle = get_string('thismylectures', 'theme_bediuk');
                $homebranchtitle = get_string('homemylectures', 'theme_bediuk');
            } else if ($mycoursetitle == 'lesson') {
                $branchtitle = get_string('mylessons', 'theme_bediuk');
                $thisbranchtitle = get_string('thismylessons', 'theme_bediuk');
                $homebranchtitle = get_string('homemylessons', 'theme_bediuk');
            } else {
                $branchtitle = get_string('mycourses', 'theme_bediuk');
                $thisbranchtitle = get_string('thismycourses', 'theme_bediuk');
                $homebranchtitle = get_string('homemycourses', 'theme_bediuk');
            }
            ...
            if ($courses = enrol_get_my_courses(NULL, 'fullname ASC')) {
                ...
                $nomycourses = '<div class="alert alert-info alert-block">' . get_string('nomycourses', 'theme_bediuk') . '</div>';
                if ($courses) {
                ...
                $noenrolments = get_string('noenrolments', 'theme_bediuk');
    ...
    protected function render_courseactivities_menu(custom_menu $menu) {
        ...
        foreach ($menu->get_children() as $item) {
            $context = $item->export_for_template($this);
            $content .= $this->render_from_template('theme_bediuk/activitygroups', $context);
        }
        return $content;
    }
    ...
    public function courseactivities_menu() {
        ...
        if (isset($COURSE->id) && $COURSE->id > 1) {
            $branchtitle = get_string('courseactivities', 'theme_bediuk');
            $branchlabel = $branchtitle;
            $branchurl = new moodle_url('#');
            $branch = $menu->add($branchlabel, $branchurl, $branchtitle, 10002);
            $data = theme_bediuk_get_course_activities();
    ...
    public function social_icons() {
        ...
        return $this->render_from_template('theme_bediuk/socialicons', $socialcontext);
    }
    ...
    public function customlogin() {
        ...
        return $this->render_from_template('theme_bediuk/customlogin', $customlogin_context);
    }
    ...
    public function teacherdash() {
        ...
        if (isloggedin() && isset($COURSE->id) && $COURSE->id > 1) {
            ...
            if (has_capability('moodle/course:viewhiddenactivities', $context)) {
                $togglebutton = get_string('coursemanagementbutton', 'theme_bediuk');
            } else {
                $togglebuttonstudent = get_string('studentdashbutton', 'theme_bediuk');
            }
        }
        $course = $this->page->course;
        $context = context_course::instance($course->id);
        ...
        $qbankdesc = get_string('qbank_desc', 'theme_bediuk');
        $badges = get_string('badges', 'theme_bediuk');
        $badgesdesc = get_string('badges_desc', 'theme_bediuk');
        $coursemanage = get_string('coursemanage', 'theme_bediuk');
        $coursemanagedesc = get_string('coursemanage_desc', 'theme_bediuk');
        ...
        $progress = $this->render_from_template('theme_bediuk/progress-bar', $progresschartcontext);

        $gradeslinkstudent = new moodle_url('/grade/report/user/index.php', array(
            'id' => $PAGE->course->id
        ));
        $hascourseinfogroup = array(
            'title' => get_string('courseinfo', 'theme_bediuk'),
            'icon' => 'map'
        );
        ...
        $hascoursestaff = array(
            'title' => get_string('coursestaff', 'theme_bediuk'),
            'icon' => 'users'
        );
        ...
        $activitylinkstitle = get_string('activitylinkstitle', 'theme_bediuk');
        $activitylinkstitle_desc = get_string('activitylinkstitle_desc', 'theme_bediuk');
        $mygradestext = get_string('mygradestext', 'theme_bediuk');
    ...
    public function teacherdashmenu() {
        ...
        $siteadmintitle = get_string('siteadminquicklink', 'theme_bediuk');
        ...
        return $this->render_from_template('theme_bediuk/teacherdashmenu', $dashmenu);
    }
