...
function theme_bediuk_get_main_scss_content($theme) {
    ...
    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/preset/Perception_variables.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/fordson_variables.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/preset/Perception.scss');

    // Page Layout
    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/pagelayout/layout1.scss');

    // Section Style
    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/sectionlayout/sectionstyle1.scss');

    if ($theme->settings->marketingstyle == 1) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/marketingstyle/marketingstyle1.scss');
    }
    if ($theme->settings->marketingstyle == 2) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/marketingstyle/marketingstyle2.scss');
    }
    if ($theme->settings->marketingstyle == 3) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/marketingstyle/marketingstyle3.scss');
    }
    if ($theme->settings->marketingstyle == 4) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/marketingstyle/marketingstyle4.scss');
    }

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/mixins.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/statistics.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/course.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/modules.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/innerpages.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/header.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/footer.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/bediuk/scss/styles.scss');
