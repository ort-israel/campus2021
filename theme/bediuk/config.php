...
$THEME->csstreepostprocessor = 'theme_bediuk_css_tree_post_processor';
$THEME->prescsscallback = 'theme_bediuk_get_pre_scss';
$THEME->extrascsscallback = 'theme_bediuk_get_extra_scss';
...
if (page_location4_incourse_themeconfig()) {
