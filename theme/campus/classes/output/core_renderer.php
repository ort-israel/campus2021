...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function full_header() {
        ...
        if ($this->is_homepage()) {
            $header->inheaderblocks = $OUTPUT->blocks('in-header');
            $header->summary = theme_campus_strip_html_tags($PAGE->course->summary);
        }

        $header->showsummary = $this->is_homepage();


        if (theme_campus_get_setting('jitsibuttontext') && $PAGE->pagelayout == 'course') {
...
' . $jitsibuttontext . ' </span></a>';
        ...
        return $this->render_from_template('theme_campus/header', $header);
    }
    ...
    public function headerimage() {
        ...
        if (theme_campus_get_setting('showcourseheaderimage') && $courseimage) {
        ...
        } else if (theme_campus_get_setting('showcourseheaderimage') && !$courseimage && isset($headerbg)) {
        ...
        } else if ($courseimage && isset($headerbg) && !theme_campus_get_setting('showcourseheaderimage')) {
            $html .= html_writer::start_div('customimage', array(
                'style' => 'background-image: url("' . $headerbgimgurl . '"); background-size: cover; background-position:center;
                width: 100%; height: 100%;'
            ));
    ...
    public function header_logo_url() {
        global $PAGE;
        return $PAGE->theme->setting_file_url('headerlogo', 'headerlogo');
    ...
    */
    ...
    public function fordson_custom_menu() {
        ...
        if (isloggedin() && !isguestuser() && $hasdisplaymycourses) {
            ...
            if ($mycoursetitle == 'module') {
                $branchtitle = get_string('mymodules', 'theme_campus');
                $thisbranchtitle = get_string('thismymodules', 'theme_campus');
                $homebranchtitle = get_string('homemymodules', 'theme_campus');
            } else if ($mycoursetitle == 'unit') {
                $branchtitle = get_string('myunits', 'theme_campus');
                $thisbranchtitle = get_string('thismyunits', 'theme_campus');
                $homebranchtitle = get_string('homemyunits', 'theme_campus');
            } else if ($mycoursetitle == 'class') {
                $branchtitle = get_string('myclasses', 'theme_campus');
                $thisbranchtitle = get_string('thismyclasses', 'theme_campus');
                $homebranchtitle = get_string('homemyclasses', 'theme_campus');
            } else if ($mycoursetitle == 'training') {
                $branchtitle = get_string('mytraining', 'theme_campus');
                $thisbranchtitle = get_string('thismytraining', 'theme_campus');
                $homebranchtitle = get_string('homemytraining', 'theme_campus');
            } else if ($mycoursetitle == 'pd') {
                $branchtitle = get_string('myprofessionaldevelopment', 'theme_campus');
                $thisbranchtitle = get_string('thismyprofessionaldevelopment', 'theme_campus');
                $homebranchtitle = get_string('homemyprofessionaldevelopment', 'theme_campus');
            } else if ($mycoursetitle == 'cred') {
                $branchtitle = get_string('mycred', 'theme_campus');
                $thisbranchtitle = get_string('thismycred', 'theme_campus');
                $homebranchtitle = get_string('homemycred', 'theme_campus');
            } else if ($mycoursetitle == 'plan') {
                $branchtitle = get_string('myplans', 'theme_campus');
                $thisbranchtitle = get_string('thismyplans', 'theme_campus');
                $homebranchtitle = get_string('homemyplans', 'theme_campus');
            } else if ($mycoursetitle == 'comp') {
                $branchtitle = get_string('mycomp', 'theme_campus');
                $thisbranchtitle = get_string('thismycomp', 'theme_campus');
                $homebranchtitle = get_string('homemycomp', 'theme_campus');
            } else if ($mycoursetitle == 'program') {
                $branchtitle = get_string('myprograms', 'theme_campus');
                $thisbranchtitle = get_string('thismyprograms', 'theme_campus');
                $homebranchtitle = get_string('homemyprograms', 'theme_campus');
            } else if ($mycoursetitle == 'lecture') {
                $branchtitle = get_string('mylectures', 'theme_campus');
                $thisbranchtitle = get_string('thismylectures', 'theme_campus');
                $homebranchtitle = get_string('homemylectures', 'theme_campus');
            } else if ($mycoursetitle == 'lesson') {
                $branchtitle = get_string('mylessons', 'theme_campus');
                $thisbranchtitle = get_string('thismylessons', 'theme_campus');
                $homebranchtitle = get_string('homemylessons', 'theme_campus');
            } else {
                $branchtitle = get_string('mycourses', 'theme_campus');
                $thisbranchtitle = get_string('thismycourses', 'theme_campus');
                $homebranchtitle = get_string('homemycourses', 'theme_campus');
            }
            ...
            if ($courses = enrol_get_my_courses(NULL, 'fullname ASC')) {
                if (theme_campus_get_setting('frontpagemycoursessorting')) {
                    $courses = enrol_get_my_courses(null, 'sortorder ASC');
                    $nomycourses = '<div class="alert alert-info alert-block">' . get_string('nomycourses', 'theme_campus') . '</div>';
                    if ($courses) {
                ...
                $noenrolments = get_string('noenrolments', 'theme_campus');
    ...
    protected function render_courseactivities_menu(custom_menu $menu) {
        ...
        foreach ($menu->get_children() as $item) {
            $context = $item->export_for_template($this);
            $content .= $this->render_from_template('theme_campus/activitygroups', $context);
        }
        return $content;
    }
    ...
    public function courseactivities_menu() {
        ...
        if (isset($COURSE->id) && $COURSE->id > 1) {
            $branchtitle = get_string('courseactivities', 'theme_campus');
            $branchlabel = $branchtitle;
            $branchurl = new moodle_url('#');
            $branch = $menu->add($branchlabel, $branchurl, $branchtitle, 10002);
            $data = theme_campus_get_course_activities();
    ...
    public function social_icons() {
        ...
        return $this->render_from_template('theme_campus/socialicons', $socialcontext);
    }
    ...
    public function customlogin() {
        ...
        return $this->render_from_template('theme_campus/customlogin', $customlogin_context);
    }
    ...
    public function teacherdashmenu() {
        ...
        if (isloggedin() && isset($COURSE->id) && $COURSE->id > 1) {
            ...
            if (has_capability('moodle/course:viewhiddenactivities', $context)) {
                $togglebutton = get_string('coursemanagementbutton', 'theme_campus');
            } else {
                $togglebuttonstudent = get_string('studentdashbutton', 'theme_campus');
            }
        }
        $siteadmintitle = get_string('siteadminquicklink', 'theme_campus');
        ...
        return $this->render_from_template('theme_campus/teacherdashmenu', $dashmenu);
    }
    ...
    public function teacherdash() {
        ...
        // Link catagories.
        $haspermission = has_capability('enrol/category:config', $context) && $PAGE->theme->settings->coursemanagementtoggle && isset($COURSE->id) && $COURSE->id > 1;
        $userlinks = get_string('userlinks', 'theme_campus');
        $userlinksdesc = get_string('userlinks_desc', 'theme_campus');
        $qbank = get_string('qbank', 'theme_campus');
        $qbankdesc = get_string('qbank_desc', 'theme_campus');
        $badges = get_string('badges', 'theme_campus');
        $badgesdesc = get_string('badges_desc', 'theme_campus');
        $coursemanage = get_string('coursemanage', 'theme_campus');
        $coursemanagedesc = get_string('coursemanage_desc', 'theme_campus');
        ...
        $progress = $this->render_from_template('theme_campus/progress-bar', $progresschartcontext);

        $gradeslinkstudent = new moodle_url('/grade/report/user/index.php', array(
            'id' => $PAGE->course->id
        ));
        $hascourseinfogroup = array(
            'title' => get_string('courseinfo', 'theme_campus'),
            'icon' => 'map'
        );
        $summary = theme_campus_strip_html_tags($COURSE->summary);
        $summarytrim = theme_campus_course_trim_char($summary, 300);
        $courseinfo = array(
            array(
        ...
        $hascoursestaff = array(
            'title' => get_string('coursestaff', 'theme_campus'),
            'icon' => 'users'
        );
        ...
        $activitylinkstitle = get_string('activitylinkstitle', 'theme_campus');
        $activitylinkstitle_desc = get_string('activitylinkstitle_desc', 'theme_campus');
        $mygradestext = get_string('mygradestext', 'theme_campus');
        ...
        return $this->render_from_template('theme_campus/teacherdash', $dashlinks);
    }
    ...
    public function footer_details_title() {
        return get_string('contactandsupporttitle', 'theme_campus');
    }
    ...
    /**
     * Get total number of active courses, teachers, and students
     * @return string
     */
    public function fp_statistics() {
        ...
        $coursesql = $select . $inner_join . $where;

        /* Get Cours Count*/
        $coursecount = $DB->get_field_sql($coursesql); // Get course count of courses not in archive category

        /* Get teacher count - editingteacher + teacher */
        /* There are a few criteria for active teachers:
        1. The userid in the role_assignments table should be distinct (the same user appears there as many times as the courses in which sh is a teacher)
        2. The courses in which they are teachers are visible
        3. The courses are not directly in, or in a descendent categroy of, the ARCHIVE category - id 166
        4. The courses' category is visible
        5. The courses' end date is not specified (i.e., is 0)
        6. The courses' end date is later than today */
        $select = 'SELECT COUNT(DISTINCT userid) FROM {role} AS r ';
        $inner_join = 'INNER JOIN {role_assignments} AS ra ON ra.roleid = r.id ';
        $inner_join .= 'INNER JOIN {context} AS co ON co.id=ra.contextid ';
        $inner_join .= 'INNER JOIN {course} AS c ON c.id = co.instanceid ';
        $inner_join .= 'INNER JOIN {course_categories} AS cc ON cc.id = c.category ';
        $inner_join .= 'INNER JOIN {user} AS u ON ra.userid = u.id ';
        $whereteacher = 'AND r.shortname = \'editingteacher\' OR r.shortname = \'teacher\' ';
        $where = 'WHERE c.visible=1 ';
        $where .= 'AND u.deleted=0 ';
        $where .= 'AND cc.path NOT LIKE \'%/166/%\' AND cc.path not LIKE \'%/166\' ';
        $where .= 'AND cc.visible=1 ';
        $where .= 'AND (c.enddate = 0 OR c.enddate >= UNIX_TIMESTAMP(NOW())) ';

        $teachersql = $select . $inner_join . $where . $whereteacher;

        /* Get Cours Count*/
        $teachercount = $DB->get_field_sql($teachersql);

        /* Get student count */
        /* The same criteria as teacher */
        $wherestudent = 'AND r.shortname = \'student\' ';
        $studentsql = $select . $inner_join . $where . $wherestudent;
        $studentcount = $DB->get_field_sql($studentsql);

        /* Get strings*/
        $statisticstitle = get_string('statisticstitle', 'theme_campus');
        $statisticscourses = get_string('courses', 'theme_campus');
        $statisticsteachers = get_string('teachers', 'theme_campus');
        $statisticsstudents = get_string('students', 'theme_campus');

        /* Build object to be read by mustache */
        $fp_statistics = [
            'statisticstitle' => $statisticstitle,
            'statisticscourses' => $statisticscourses,
            'statisticsteachers' => $statisticsteachers,
        ...
        return $this->render_from_template('theme_campus/fpstatistics', $fp_statistics);
    }
