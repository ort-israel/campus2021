 ...
 */
namespace theme_campus\output\core;
...
if ($PAGE->theme->settings->coursetilestyle < 10) {
            ...
            if (count($rcourseids) > 0) {
                foreach ($acourseids as $courseids) {
                    ...
                    foreach ($courseids as $courseid) {
                        ...
                        $summary = format_text(theme_campus_course_trim_char($summary, $trimsummaryvalue));
                        $trimtitle = format_string(theme_campus_course_trim_char($course->fullname, $trimtitlevalue));
                        ...
                        if ($PAGE->theme->settings->coursetilestyle == 2) {
                            ...
                            $enrollbutton = get_string('enrollcoursecard', 'theme_campus');
                            $rowcontent .= '
                    <div class="col-md-4">
                        ';
                            $rowcontent .= '
    ...
    background-blend-mode: overlay;">
        ...
        protected function coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
            if (!theme_campus_get_setting('enablecategoryicon')) {
            ...
            $val = theme_campus_get_setting('catsicon');
