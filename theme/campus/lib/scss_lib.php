 ...
 */
function theme_campus_css_tree_post_processor($tree, $theme) {
...
function theme_campus_get_main_scss_content($theme) {
    ...
    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/preset/Perception.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/fordson_variables.scss');

    // Page Layout
    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/pagelayout/layout1.scss');

    // Section Style
    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/sectionlayout/sectionstyle1.scss');

    if ($theme->settings->marketingstyle == 1) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/marketingstyle/marketingstyle1.scss');
    }
    if ($theme->settings->marketingstyle == 2) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/marketingstyle/marketingstyle2.scss');
    }
    if ($theme->settings->marketingstyle == 3) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/marketingstyle/marketingstyle3.scss');
    }
    if ($theme->settings->marketingstyle == 4) {
        $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/marketingstyle/marketingstyle4.scss');
    }

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/mixins.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/featuredcourses.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/categorylist.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/statistics.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/homepage.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/course.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/modules.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/innerpages.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/header.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/footer.scss');

    $scss .= file_get_contents($CFG->dirroot . '/theme/campus/scss/styles.scss');
