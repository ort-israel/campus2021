...
$THEME->layouts = [
    ...
    'frontpage' => [
        'file' => 'frontpage.php',
        'regions' => ['in-header', 'above-content'],
...
if (isset($THEME->settings->enhancedmydashboard) && $THEME->settings->enhancedmydashboard == 1 && $THEME->settings->blockdisplay == 1) {
    $THEME->layouts['mydashboard'] = [
        'file' => 'mydashboard.php',
        'regions' => ['fp-a', 'fp-b', 'fp-c', 'side-pre', 'above-content'],
        'defaultregion' => 'above-content',
        'options' => ['nonavbar' => true, 'langmenu' => true],
    ];
}
...
if (isset($THEME->settings->blockdisplay) && $THEME->settings->blockdisplay == 2 && $THEME->settings->enhancedmydashboard == 1) {
    $THEME->layouts['mydashboard'] = [
        'file' => 'mydashboard.php',
        'regions' => ['side-pre', 'above-content'],
        'defaultregion' => 'above-content',
        'options' => ['nonavbar' => true, 'langmenu' => true],
    ];
}
...
$THEME->csstreepostprocessor = 'theme_campus_css_tree_post_processor';
