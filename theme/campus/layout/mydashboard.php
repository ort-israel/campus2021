...
$blockshtmlabove = $OUTPUT->blocks('above-content');
$hasblocksabove = strpos($blockshtmlabove, 'data-block=') !== false;
...
echo $OUTPUT->render_from_template('theme_campus/mydashboard', $templatecontext);
