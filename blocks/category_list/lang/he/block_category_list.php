...
/**
 * Strings for component 'block_category_list', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['category_list:addinstance'] = 'Add a new courses block';
$string['category_list:myaddinstance'] = 'Add a new courses block to Dashboard';
$string['hideallcourseslink'] = 'Hide \'All courses\' link';
$string['owncourses'] = 'Admin user sees own courses';
$string['pluginname'] = ' תחומי דעת';
$string['disciplines'] = 'תחומי דעת';
$string['catid'] = 'catid';
$string['configcatid'] = 'configcatid';
$string['fulllistofdisciplines'] = 'כל תחומי הדעת';
